(function() {
    ...
    angular
        .module('onsPortalApp')
        .controller('RetificacaoDetailController', RetificacaoDetailController);

    RetificacaoDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'entity', 'Schedule', '$uibModalInstance', 'ScheduleService'];

    function RetificacaoDetailController($scope, $rootScope, $stateParams, entity, Schedule, $uibModalInstance, ScheduleService) {
        var vm = this;
