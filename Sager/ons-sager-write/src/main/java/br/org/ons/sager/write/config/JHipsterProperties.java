package br.org.ons.sager.write.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ONSSagerWrite@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ONSSagerWrite API";

        private String description = "ONSSagerWrite API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ONSSagerWrite";
