...
@IntegrationTest
public class CalcularDisponibilidadeRF02 {
	@Autowired
	...
	public void CT01001() {
		try {
			...
			disponibilidades.add(br.org.ons.geracao.evento.TipoDisponibilidade.ELETROMECANICA);
	...
	public void CT01002() {
		try {
			...
			if (cdResponse.getDisponibilidades() != null) {
				for (Disponibilidade d : cdResponse.getDisponibilidades()) {
					if (i == 0) {
						assertThat(d.getValor().doubleValue()).isEqualTo(33.333333333333336);
					}
					if (i == 1) {
						assertThat(d.getValor().doubleValue()).isEqualTo(200.0);
					}
					if (i == 2) {
						assertThat(d.getValor().doubleValue()).isEqualTo(200.0);
					}
	...
	public void CT01004() {
		try {
			...
			if (cdResponse.getDisponibilidades() != null) {
				for (Disponibilidade d : cdResponse.getDisponibilidades()) {
					if(i == 0){
						assertThat(d.getValor().doubleValue()).isEqualTo(200.00);
					}
					if(i == 1){
						assertThat(d.getValor().doubleValue()).isEqualTo(200.0);
					}
