...
@IntegrationTest
public class VerificaSituacaoInstalacaoRF03 {
	...
	/**
	 * CT01001  Usina com todos equipamento FOC antes da janela de cálculo.
	 */
	@Test
	public void testCT01001() {
		try {	
			...
			ug.setDataImplantacao(sdf.parse("01/09/2016 00:00"));
			ug.setDataEventoEOC(sdf.parse("01/09/2016 00:00"));
			
			ug.setSuspensoes(new ArrayList<Periodo>());
			
			UnidadeGeradora ug1 = new UnidadeGeradora();
			ug1.setDataImplantacao(sdf.parse("01/09/2016 00:00"));
			ug1.setDataEventoEOC(sdf.parse("01/09/2016 00:00"));
			...
			if( verificarResponse.getComentarios() != null && verificarResponse.getComentarios().size() > 0 ){
				for (ComentarioSituacao cs : verificarResponse.getComentarios()) {
					if ( cs.getTipoObjeto().equals(ComentarioSituacao.TipoObjeto.UNIDADE_GERADORA)&& 
							cs.getStatusObjeto().equals(ComentarioSituacao.StatusObjeto.FORA_OPERACAO_COMERCIAL)) {
	...
	/**
	 * CT01002 Usina com 1 equipamento fora operacao comercial antes da janela de cálculo.
	 */
	...
	public void testCT01002() {
		...
		try {	
			...
			UnidadeGeradora ug = new UnidadeGeradora();
			ug.setDataImplantacao(sdf.parse("01/11/2010 00:00"));
			ug.setDataEventoEOC(sdf.parse("01/11/2010 00:00"));
	...
	/**
	 * CT01003 Usina com 1 equipamento foc depois da janela de cálculo.
	 */
	@Test
	public void testCT01003() {
			...
			UnidadeGeradora ug1 = new UnidadeGeradora();
			ug1.setDataImplantacao(sdf.parse("01/11/2016 00:00"));
			ug1.setDataEventoEOC(sdf.parse("01/11/2016 00:00"));
			ug1.setSuspensoes(new ArrayList<Periodo>());
	...
	/**
	 * Usina com todos equipamento foc depois da janela de cálculo.
	 * 
	 */
	@Test
	public void testCT01004() {
			...
			UnidadeGeradora ug = new UnidadeGeradora();
			ug.setDataImplantacao(sdf.parse("01/11/2016 00:00"));
			ug.setDataEventoEOC(sdf.parse("01/11/2016 00:00"));
	...
	/**
	 * Usina com 1 equipamento foc dentro da janela de cálculo.
	 */
	...
	public void testCT01005() {
			...
			UnidadeGeradora ug = new UnidadeGeradora();
			ug.setDataImplantacao(sdf.parse("05/10/2016 00:00"));
			ug.setDataEventoEOC(sdf.parse("05/10/2016 00:00"));
	...
	/**
	 * Usina com todos equipamento foc dentro da janela de cálculo.
	 */
	@Test
	public void testCT01006() {
			...
			UnidadeGeradora ug1 = new UnidadeGeradora();
			ug1.setDataImplantacao(sdf.parse("05/10/2016 00:00"));
			ug1.setDataEventoEOC(sdf.parse("05/10/2016 00:00"));
			
			ug1.setSuspensoes(new ArrayList<Periodo>());
			
			UnidadeGeradora ug2 = new UnidadeGeradora();
			ug2.setDataImplantacao(sdf.parse("05/10/2016 00:00"));
			ug2.setDataEventoEOC(sdf.parse("05/10/2016 00:00"));
	...
	/**
	 * Instalacação Internacional foc antes da janela de cálculo.
	 */
	@Test
	public void testCT01007() {
			...
			ei.setDataImplantacao(sdf.parse("01/09/2016 00:00"));
			ei.setDataEventoEOC(sdf.parse("01/09/2016 00:00"));
	...
	/**
	 * Instalacação Internacional foc depois da janela de cálculo.
	 *
	 */
	@Test
	public void testCT01008() {
		...
		try {	
			...
			EquipamentoInterligacaoInternacional ei = new EquipamentoInterligacaoInternacional();
			ei.setDataImplantacao(sdf.parse("01/11/2016 00:00"));
			ei.setDataEventoEOC(sdf.parse("01/11/2016 00:00"));
			it.setEquipamento(ei);
	...
	/**
	 * Instalacação Internacional foc dentro da janela de cálculo.
	 */
	@Test
	public void testCT01009() {
			...
			EquipamentoInterligacaoInternacional ei = new EquipamentoInterligacaoInternacional();
			ei.setDataImplantacao(sdf.parse("05/10/2016 00:00"));
			ei.setDataEventoEOC(sdf.parse("05/10/2016 00:00"));
