...
public class GeraTipSinc_JavaCompute_Dat2base64 extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement outJsonTest = outJsonData.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "arquivoDat", "TIPSINC.DAT");
