...
public class GeraDispVer_CSV2Base64 extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly assembly) throws MbException {
		...
		try {
			...
			byte[] datBase64Bytes = message.getRootElement().getFirstElementByPath("DFDL/ArqDispVerDat").toBitstream(null, null, null, 0, 1208, 0);
