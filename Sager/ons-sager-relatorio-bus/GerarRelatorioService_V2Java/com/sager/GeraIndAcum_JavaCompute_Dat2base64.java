...
public class GeraIndAcum_JavaCompute_Dat2base64 extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			byte[] datBase64Bytes = inMessage.getRootElement().getFirstElementByPath("DFDL/ArqIndAcumDat").toBitstream(null, null, null, 0, 1208, 0);
			...
			MbElement outJsonTest = outJsonData.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "arquivoDat", "INDACUM.DAT");
