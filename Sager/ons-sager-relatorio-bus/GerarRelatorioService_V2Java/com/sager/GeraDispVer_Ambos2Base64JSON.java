...
public class GeraDispVer_Ambos2Base64JSON extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement outJsonTest = outJsonData.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "arquivoXML", "DISPVER.XML");
			...
			outJsonTest = outJsonData.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "arquivoDat", "DISPVER.DAT");
