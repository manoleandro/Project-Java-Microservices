...
@EnableMapRepositories("br.org.ons.sager.parametrizacao.repository")
public class WXSConfiguration {
	...
	@Bean
	public Jackson2RepositoryPopulatorFactoryBean jackson2RepositoryPopulator() throws IOException {
		Jackson2RepositoryPopulatorFactoryBean populatorFactory = new Jackson2RepositoryPopulatorFactoryBean();
		populatorFactory.setMapper(objectMapper);
		populatorFactory
