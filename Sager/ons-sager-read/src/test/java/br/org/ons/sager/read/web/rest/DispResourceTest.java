...
//import br.org.ons.sager.read.web.rest.dto.UsinaDTO;
//import br.org.ons.sager.read.web.rest.dto.UsinaDispDTO;
//import br.org.ons.sager.read.web.rest.dto.UsinaRequest;
...
//		Date dataDisp1 = new Date("2016/11/28 03:00:00");
...
//		 comentSituacao1.setDescricao("Descricao01");
...
////		
////		assertThat(dispRepository.count() == 1).isTrue();
////
////	}
////
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispEle() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispOp() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
////							disp1.setValor(12.30);
////							disp1.setVersao("1");
////							disp1.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							
////							disponibilidades.add(disp1);
////
////							resp.setDisponibilidades(disponibilidades);
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void busComLDispVazio() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispCompletoComercial() throws Exception {
////
////		Disp disp2 = new Disp();
////		disp2.setTipo("O");
////		disp2.setInstalacao("RJUSCP");
////		Date dataDisp2 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp3 = new Date("2016/11/28 04:00:00");
...
////		Date dataDisp5 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp6 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp7 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp8 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp9 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp10 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp11 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp12 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp13 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp14 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp15 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp16 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp17 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp18 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp19 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp20 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp21 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp22 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp23 = new Date("2016/11/28 03:00:00");
...
////		Date dataDisp24 = new Date("2016/11/28 03:00:00");
...
////							disp7.setDataInicio(dataInicio7);
...
////							disp8.setDataInicio(dataInicio8);
...
////							disp9.setDataInicio(dataInicio9);
...
////							disp10.setDataInicio(dataInicio10);
...
////							disp11.setDataInicio(dataInicio11);
...
////							disp12.setDataInicio(dataInicio12);
...
////							disp13.setDataInicio(dataInicio13);
...
////							disp14.setDataInicio(dataInicio14);
...
////							disp15.setDataInicio(dataInicio15);
...
////							disp16.setDataInicio(dataInicio16);
...
////							disp17.setDataInicio(dataInicio17);
...
////							disp18.setDataInicio(dataInicio18);
...
////							disp19.setDataInicio(dataInicio19);
...
////							disp20.setDataInicio(dataInicio20);
...
////							disp21.setDataInicio(dataInicio21);
...
////							disp22.setDataInicio(dataInicio22);
...
////							disp23.setDataInicio(dataInicio23);
...
////							disp24.setDataInicio(dataInicio24);
...
////
////		String response = restDispMockMvc
////				.perform(post("/api/disp").param("dtFim", "2016-11-28T23:59:59.999Z")
...
////		System.out.println("Response" + response);
////
////		assertThat(dispRepository.count() == 24).isTrue();
////
////	}
////	
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispCompletoEletromecanica() throws Exception {
////
////		Disp disp2 = new Disp();
////		disp2.setTipo("O");
////		disp2.setInstalacao("RJUSCP");
...
////							disp2.setIdEquipamento("RJUSCP0UG1");
////							disp2.setValor(12.31);
////							disp2.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp2.setVersao("1");
////							disp2.setId("2");
////							
////							Date dataInicio3 = new Date("2016/11/28 03:00:00");
...
////							disp5.setIdEquipamento("RJUSCP0UG1");
////							disp5.setValor(12.31);
////							disp5.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp5.setVersao("1");
////							disp5.setId("5");
////
////							Date dataInicio6 = new Date("2016/11/28 06:00:00");
...
////							disp6.setIdEquipamento("RJUSCP0UG1");
////							disp6.setValor(12.31);
////							disp6.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp6.setVersao("1");
////							disp6.setId("6");
////
////							Date dataInicio7 = new Date("2016/11/28 07:00:00");
...
////							disp7.setIdEquipamento("RJUSCP0UG1");
////							disp7.setValor(12.31);
////							disp7.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp7.setVersao("1");
////							disp7.setId("7");
////
////							Date dataInicio8 = new Date("2016/11/28 08:00:00");
...
////							disp8.setIdEquipamento("RJUSCP0UG1");
////							disp8.setValor(12.31);
////							disp8.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp8.setVersao("1");
////							disp8.setId("8");
////
////							Date dataInicio9 = new Date("2016/11/28 09:00:00");
...
////							disp9.setIdEquipamento("RJUSCP0UG1");
////							disp9.setValor(12.32);
////							disp9.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp9.setVersao("1");
////							disp9.setId("9");
////
////							Date dataInicio10 = new Date("2016/11/28 10:00:00");
...
////							disp10.setIdEquipamento("RJUSCP0UG1");
////							disp10.setValor(12.31);
////							disp10.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp10.setVersao("1");
////							disp10.setId("10");
////							
////
...
////							disp11.setIdEquipamento("RJUSCP0UG1");
////							disp11.setValor(12.32);
////							disp11.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp11.setVersao("1");
////							disp11.setId("11");
////							
////
...
////							disp12.setIdEquipamento("RJUSCP0UG1");
////							disp12.setValor(12.32);
////							disp12.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp12.setVersao("1");
////							disp12.setId("12");
////							
////
...
////							disp13.setIdEquipamento("RJUSCP0UG1");
////							disp13.setValor(12.30);
////							disp13.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp13.setVersao("1");
////							disp13.setId("13");
////							
////
...
////							disp14.setIdEquipamento("RJUSCP0UG1");
////							disp14.setValor(12.30);
////							disp14.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp14.setVersao("1");
////							disp14.setId("14");
////							
////
...
////							disp15.setIdEquipamento("RJUSCP0UG1");
////							disp15.setValor(12.30);
////							disp15.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp15.setVersao("1");
////							disp15.setId("15");
////							
////							Date dataInicio16 = new Date("2016/11/28 16:00:00");
...
////							disp16.setIdEquipamento("RJUSCP0UG1");
////							disp16.setValor(12.30);
////							disp16.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp16.setVersao("1");		
////							disp16.setId("16");
////							
////							Date dataInicio17 = new Date("2016/11/28 17:00:00");
...
////							disp17.setIdEquipamento("RJUSCP0UG1");
////							disp17.setValor(12.30);
////							disp17.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp17.setVersao("1");	
////							disp17.setId("17");
////							
////							Date dataInicio18 = new Date("2016/11/28 18:00:00");
...
////							disp18.setIdEquipamento("RJUSCP0UG1");
////							disp18.setValor(12.30);
////							disp18.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp18.setVersao("1");				
////							disp18.setId("18");
////							
////							Date dataInicio19 = new Date("2016/11/28 19:00:00");
...
////							disp19.setIdEquipamento("RJUSCP0UG1");
////							disp19.setValor(12.30);
////							disp19.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp19.setVersao("1");
////							disp19.setId("19");
////							
////
...
////							disp20.setIdEquipamento("RJUSCP0UG1");
////							disp20.setValor(12.30);
////							disp20.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp20.setVersao("1");
////							disp20.setId("20");
////
////							Date dataInicio21 = new Date("2016/11/28 21:00:00");
...
////							disp21.setIdEquipamento("RJUSCP0UG1");
////							disp21.setValor(12.30);
////							disp21.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp21.setVersao("1");
////							disp21.setId("21");
////
////							Date dataInicio22 = new Date("2016/11/28 22:00:00");
...
////							disp22.setIdEquipamento("RJUSCP0UG1");
////							disp22.setValor(12.30);
////							disp22.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp22.setVersao("1");
////							disp22.setId("22");
////
////							Date dataInicio23 = new Date("2016/11/28 23:00:00");
...
////							disp23.setIdEquipamento("RJUSCP0UG1");
////							disp23.setValor(12.30);
////							disp23.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp23.setVersao("1");
////							disp23.setId("23");
////							
////
...
////							disp24.setIdEquipamento("RJUSCP0UG1");
////							disp24.setValor(12.30);
////							disp24.setTipoDisponibilidade(TipoDisponibilidade.ELETROMECANICA);
////							disp24.setVersao("1");
////							disp24.setId("24");
////							
////							disponibilidades.add(disp1);
...
////				.perform(post("/api/disp").param("dtFim", "2016-11-28T23:59:59.999Z")
////						.param("dtInicio", "2016-11-28T02:00:00.000Z").param("page", "0").param("size", "20")
////						.param("sort", "id,asc").param("tipos", "E").content(content)
////						.contentType(MediaType.APPLICATION_JSON_UTF8))
////				.andExpect(status().isOk()).andReturn().getResponse().getContentAsString();
////
////		System.out.println("Response" + response);
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispCompletoOperacional() throws Exception {
////
////		Disp disp2 = new Disp();
////		disp2.setTipo("E");
////		disp2.setInstalacao("RJUSCP");
...
////							disp2.setIdEquipamento("RJUSCP0UG1");
////							disp2.setValor(12.31);
////							disp2.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp2.setVersao("1");
////							disp2.setId("2");
////							
////							Date dataInicio3 = new Date("2016/11/28 03:00:00");
...
////							disp3.setIdEquipamento("RJUSCP0UG1");
////							disp3.setValor(12.31);
////							disp3.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp3.setVersao("1");
////							disp3.setId("3");
////							
////							Date dataInicio4 = new Date("2016/11/28 04:00:00");
...
////							disp4.setIdEquipamento("RJUSCP0UG1");
////							disp4.setValor(12.31);
////							disp4.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp4.setVersao("1");
////							disp4.setId("4");
////							
////							Date dataInicio5 = new Date("2016/11/28 05:00:00");
...
////							disp7.setIdEquipamento("RJUSCP0UG1");
////							disp7.setValor(12.31);
////							disp7.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp7.setVersao("1");
////							disp7.setId("7");
////
////							Date dataInicio8 = new Date("2016/11/28 08:00:00");
...
////							disp8.setIdEquipamento("RJUSCP0UG1");
////							disp8.setValor(12.31);
////							disp8.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp8.setVersao("1");
////							disp8.setId("8");
////
////							Date dataInicio9 = new Date("2016/11/28 09:00:00");
...
////							disp9.setIdEquipamento("RJUSCP0UG1");
////							disp9.setValor(12.32);
////							disp9.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp9.setVersao("1");
////							disp9.setId("9");
////
////							Date dataInicio10 = new Date("2016/11/28 10:00:00");
...
////							disp10.setIdEquipamento("RJUSCP0UG1");
////							disp10.setValor(12.31);
////							disp10.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp10.setVersao("1");
////							disp10.setId("10");
////							
////
...
////							disp11.setIdEquipamento("RJUSCP0UG1");
////							disp11.setValor(12.32);
////							disp11.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp11.setVersao("1");
////							disp11.setId("11");
////							
////
...
////							disp12.setIdEquipamento("RJUSCP0UG1");
////							disp12.setValor(12.32);
////							disp12.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp12.setVersao("1");
////							disp12.setId("12");
////							
////
...
////							disp13.setIdEquipamento("RJUSCP0UG1");
////							disp13.setValor(12.30);
////							disp13.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp13.setVersao("1");
////							disp13.setId("13");
////							
////
...
////							disp14.setIdEquipamento("RJUSCP0UG1");
////							disp14.setValor(12.30);
////							disp14.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp14.setVersao("1");
////							disp14.setId("14");
////							
////
...
////							disp15.setIdEquipamento("RJUSCP0UG1");
////							disp15.setValor(12.30);
////							disp15.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp15.setVersao("1");
////							disp15.setId("15");
////							
////							Date dataInicio16 = new Date("2016/11/28 16:00:00");
...
////							disp16.setIdEquipamento("RJUSCP0UG1");
////							disp16.setValor(12.30);
////							disp16.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp16.setVersao("1");		
////							disp16.setId("16");
////							
////							Date dataInicio17 = new Date("2016/11/28 17:00:00");
...
////							disp17.setIdEquipamento("RJUSCP0UG1");
////							disp17.setValor(12.30);
////							disp17.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp17.setVersao("1");	
////							disp17.setId("17");
////							
////							Date dataInicio18 = new Date("2016/11/28 18:00:00");
...
////							disp18.setIdEquipamento("RJUSCP0UG1");
////							disp18.setValor(12.30);
////							disp18.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp18.setVersao("1");				
////							disp18.setId("18");
////							
////							Date dataInicio19 = new Date("2016/11/28 19:00:00");
...
////							disp19.setIdEquipamento("RJUSCP0UG1");
////							disp19.setValor(12.30);
////							disp19.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp19.setVersao("1");
////							disp19.setId("19");
////							
////
...
////							disp20.setIdEquipamento("RJUSCP0UG1");
////							disp20.setValor(12.30);
////							disp20.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp20.setVersao("1");
////							disp20.setId("20");
////
////							Date dataInicio21 = new Date("2016/11/28 21:00:00");
...
////							disp21.setIdEquipamento("RJUSCP0UG1");
////							disp21.setValor(12.30);
////							disp21.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp21.setVersao("1");
////							disp21.setId("21");
////
////							Date dataInicio22 = new Date("2016/11/28 22:00:00");
...
////							disp22.setIdEquipamento("RJUSCP0UG1");
////							disp22.setValor(12.30);
////							disp22.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp22.setVersao("1");
////							disp22.setId("22");
////
////							Date dataInicio23 = new Date("2016/11/28 23:00:00");
...
////							disp23.setIdEquipamento("RJUSCP0UG1");
////							disp23.setValor(12.30);
////							disp23.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp23.setVersao("1");
////							disp23.setId("23");
////							
////
...
////							disp24.setIdEquipamento("RJUSCP0UG1");
////							disp24.setValor(12.30);
////							disp24.setTipoDisponibilidade(TipoDisponibilidade.OPERACIONAL);
////							disp24.setVersao("1");
////							disp24.setId("24");
////							
////							disponibilidades.add(disp1);
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispTotal() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
////
////		String response = restDispMockMvc
////				.perform(post("/api/disp").param("dtFim", "2016-11-29T02:59:59.999Z")
////						.param("dtInicio", "2016-11-28T03:00:00.000Z").param("page", "0").param("size", "20")
////						.param("sort", "id,asc").param("tipos", "O").content(content)
////						.contentType(MediaType.APPLICATION_JSON_UTF8))
////				.andExpect(status().isOk()).andReturn().getResponse().getContentAsString();
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getBadDisp() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
////				+ "\"valorPotencia\":null," + "\"participacao\":null," + "\"equipamentosEventosId\":null}],"
////				+ "\"minorVersion\":\"1\"}]";
////		String response1 = restDispMockMvc
////				.perform(post("/api/disp").param("dtFim", "2016-11-29T03:00:00.000Z")
////						.param("dtInicio", "2019-01-01T03:00:00.000Z").param("page", "0").param("size", "20")
////						.param("sort", "id,asc").param("tipos", "O").content(content)
////						.contentType(MediaType.APPLICATION_JSON_UTF8))
...
////	@SuppressWarnings("unchecked")
////	@Test
////	public void getDispUsina() throws Exception {
////
////		when(commandBus.sendAndWait(any(CommandMessage.class)))
////				.thenAnswer(new Answer<ResultMessage<?>>() {
////					@Override
...
//////							ComentarioSituacao coment4 = new ComentarioSituacao();
//////							ComentarioSituacao coment5 = new ComentarioSituacao();
//////							ComentarioSituacao coment6 = new ComentarioSituacao();
////							
...
////							comentarios.add(coment3);
////							
//////							data = new Date("2016/11/28 03:00:00");
//////							coment4.setNomeObjeto("nome04");
//////							coment4.setDescricao("Descricao04");
//////							coment4.setDataFim(data);
//////							coment4.setDataInicio(data);
//////							coment4.setDataInsercao(data);
//////							coment4.setTipoObjeto(TipoObjeto.INTERLIGACAO_INTERNACIONAL);
//////							coment4.setTipo(TipoComentario.COMENTARIO);
...
//////							
//////							data = new Date("2016/11/28 04:00:00");
//////							coment5.setNomeObjeto("nome05");
//////							coment5.setDescricao("Descricao05");
//////							coment5.setDataFim(data);
//////							coment5.setDataInicio(data);
//////							coment5.setDataInsercao(data);
//////							coment5.setTipoObjeto(TipoObjeto.INTERLIGACAO_INTERNACIONAL);
//////							coment5.setTipo(TipoComentario.AVISO);
...
//////							
//////							data = new Date("2016/11/28 05:00:00");
//////							coment6.setNomeObjeto("nome06");
//////							coment6.setDescricao("Descricao06");
//////							coment6.setDataFim(data);
//////							coment6.setDataInicio(data);
//////							coment6.setDataInsercao(data);
//////							coment6.setTipoObjeto(TipoObjeto.INTERLIGACAO_INTERNACIONAL);
//////							coment6.setTipo(TipoComentario.ERRO);
//////							
