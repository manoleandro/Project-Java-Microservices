...
public class CommandProcessor_HandleError extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			if (replyToQ != null && replyToQ.getValueAsString() != null
				...
				// Limpando os campos da mensagem
//				MbElement json = outMessage.getRootElement()
//						.getFirstElementByPath("/JSON");
//				if (json != null) json.delete();

				// Limpando os objetos de Lookup mensagem
				MbElement lookupRequest = outMessage.getRootElement().getFirstElementByPath(
						"/LookupRequest");
				if (lookupRequest != null) lookupRequest.delete();
				MbElement lookupResponse = outMessage.getRootElement().getFirstElementByPath(
						"/LookupResponse");
				if (lookupResponse != null) lookupResponse.delete();
