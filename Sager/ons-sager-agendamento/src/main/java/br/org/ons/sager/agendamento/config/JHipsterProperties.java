...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ONSSagerAgendamento@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ONSSagerAgendamento API";

        private String description = "ONSSagerAgendamento API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ONSSagerAgendamento";
